                    ...
                    <ul class="to-form-field-list">
                        <li>
                            ...
                            <span class="to-legend">
                                <?php esc_html_e('Select the type of the attribute (you will not be able to change the type after saving).','chauffeur-booking-system'); ?><br/>
                                <?php _e('<strong>Text Value</strong> is used for any custom text. For example, you can define an attribute named "color" and then specify it by entering it in a single vehicle settings.','chauffeur-booking-system'); ?><br/>
                                <?php _e('<strong>Single Choice</strong> is used for one value. For example, you can define an attribute named "transmission" with two values "automatic" and "manual" and then select one of them in a single vehicle settings.','chauffeur-booking-system'); ?><br/>
                                <?php _e('<strong>Multi Choice</strong> is used for multiple values. For example, you can define an attribute named "extras" with two values "bluetooth" and "radio" and then select all of them in a single vehicle settings.','chauffeur-booking-system'); ?>
                            </span>
                                    ...
                                    <tr>
                                        <th style="width:80%">
                                            <div>
                                                ...
                                                <span class="to-legend">
                                                    <?php esc_html_e('Specify possible values for this attribute.','chauffeur-booking-system'); ?>
                                                </span>
                                            </div>
                                        </th>
                                        <th style="width:20%">
