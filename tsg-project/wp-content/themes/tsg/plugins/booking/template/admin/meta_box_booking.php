...
<!--            <li><a href="#meta-box-booking-5">--><?php //esc_html_e('Extras', 'chauffeur-booking-system'); ?><!--</a></li>-->
            <!--                    <li><a href="#meta-box-booking-6">-->
            <?php //esc_html_e('Client','chauffeur-booking-system'); ?><!--</a></li>-->
            <!--                    <li><a href="#meta-box-booking-7">-->
            <?php //esc_html_e('Payment','chauffeur-booking-system'); ?><!--</a></li>-->
            <li><a href="#meta-box-booking-8"><?php esc_html_e('Drivers', 'chauffeur-booking-system'); ?></a></li>
        </ul>
        <div id="meta-box-booking-1">
            <ul class="to-form-field-list">
                <?php if($this->data['post']->post_type === 'chbs_booking'): ?>
                    <li>
                        ...
                        <div class="to-radio-button">
                            <?php
                            echo $bookingStatus->getBookingStatus($this->data['meta']['booking_status_id'])[0];
                            ?>
                        </div>
                    </li>
                <?php endif; ?>
                ...
                <li>
                    <h5><?php esc_html_e('Arrival airline', 'chauffeur-booking-system'); ?></h5>
                    <span class="to-legend"><?php esc_html_e('Arrival airline.', 'chauffeur-booking-system'); ?></span>
                    <div class="to-field-disabled">
                        <?php echo esc_html($this->data['meta']['arrival_airline']); ?>
                    </div>
                </li>
                <li>
                    <h5><?php esc_html_e('Arrival flight number', 'chauffeur-booking-system'); ?></h5>
                    <span class="to-legend"><?php esc_html_e('Arrival flight number.', 'chauffeur-booking-system'); ?></span>
                    <div class="to-field-disabled">
                        <?php echo esc_html($this->data['meta']['arrival_flight']); ?>
                    </div>
                </li>
                <?php
                if (in_array($this->data['meta']['service_type_id'], array(1, 3))) {
                    if ((int)$this->data['meta']['transfer_type_id'] === 3) {
                        ?>
                        <li>
                            <h5><?php esc_html_e('Return airline', 'chauffeur-booking-system'); ?></h5>
                            <span class="to-legend"><?php esc_html_e('Return airline.', 'chauffeur-booking-system'); ?></span>
                            <div class="to-field-disabled">
                                <?php echo esc_html($this->data['meta']['departure_airline']); ?>
                            </div>
                        </li>
                        <li>
                            <h5><?php esc_html_e('Return flight number', 'chauffeur-booking-system'); ?></h5>
                            <span class="to-legend"><?php esc_html_e('Return flight number.', 'chauffeur-booking-system'); ?></span>
                            <div class="to-field-disabled">
                                <?php echo esc_html($this->data['meta']['departure_flight']); ?>
                            </div>
                        </li>
                        <?php
                    }
                ...
                ?>
                <li>
                    <h5><?php esc_html_e('Contact information', 'chauffeur-booking-system'); ?></h5>
                    <span class="to-legend"><?php esc_html_e('Contact information.', 'chauffeur-booking-system'); ?></span>
                    <div class="to-field-disabled">
                        <?php echo esc_html($this->data['meta']['contact_information']); ?>
                    </div>
                </li>
                ...
                if (in_array($this->data['meta']['service_type_id'], array(1, 3))) {
                    ...
                    <li>
                        ...
                        <div class="to-field-disabled">
                            <?php  echo esc_html($Length->format($this->data['billing']['summary']['distance'])); ?>
                        </div>
                    </li>
                    <?php
                }
            ...
            <table class="to-table">
                <tr>
                    <td style="padding: 5px;">
                        <ul class="to-form-field-list">
                            <li>
                                <h5><?php esc_html_e('Arrival Vehicle', 'chauffeur-booking-system'); ?></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="to-clear-fix">
                                                        <div class="to-field-disabled">
                                                            <?php echo CHBSPrice::format($this->data['meta']['arrival_price_' . $index . '_value'], $this->data['meta']['currency_id']); ?>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="to-clear-fix">
                                                        <div class="to-field-disabled">
                                                            <?php echo $this->data['meta']['arrival_price_' . $index . '_tax_rate_value'] . '%'; ?>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <?php if($this->data['meta']['transfer_type_id'] === '3'): ?>
                        <td style="padding: 5px;">
                            <ul class="to-form-field-list">
                                <li>
                                    <h5><?php esc_html_e('Return Vehicle', 'chauffeur-booking-system'); ?></h5>
                                    <span class="to-legend"><?php esc_html_e('Vehicle name.', 'chauffeur-booking-system'); ?></span>
                                    <div class="to-field-disabled">
                                        <?php echo esc_html($this->data['meta']['vehicle_name_return']) ?>
                                        <div class="to-float-right">
                                            <?php edit_post_link(esc_html__('Edit', 'chauffeur-booking-system'), null, null, $this->data['meta']['vehicle_id_return']); ?>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                            ...
                                            foreach ($price as $index => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="to-clear-fix">
                                                            <div class="to-field-disabled">
                                                                <?php echo CHBSPrice::format($this->data['meta']['return_price_' . $index . '_value'], $this->data['meta']['currency_id']); ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="to-clear-fix">
                                                            <div class="to-field-disabled">
                                                                <?php echo $this->data['meta']['return_price_' . $index . '_tax_rate_value'] . '%'; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                ...
                <ul class="to-form-field-list">
                    <li>
                        ...
                        <div>
                            <table class="to-table" id="to-table-vehicle-attribute">
                                <tr>
                                    <th <?php echo ($this->data['meta']['transfer_type_id'] === '3') ? 'style="width:30%"' : 'style="width:40%"'; ?>>
                                        <div>
                                    ...
                                    <?php if ($this->data['meta']['transfer_type_id'] === '3'): ?>
                                        <th class="to-align-right" style="width:10%">
                                            <div>
                                                <?php esc_html_e('Quantity Return', 'chauffeur-booking-system'); ?>
                                                <span class="to-legend">
                                                    <?php esc_html_e('Quantity Return.', 'chauffeur-booking-system'); ?>
                                                </span>
                                            </div>
                                ...
                                <?php
                                $extra_data = $this->data['meta']['booking_extra'];
                                if (!is_array($extra_data)) {
                                    $extra_data = unserialize($extra_data);
                                }
                                foreach ($extra_data as $index => $value) {
                                    $quantity_return = ($this->data['meta']['transfer_type_id'] === '3') ? $value['quantity_return'] : 0;

                                    ?>
                                    <tr>
                                        <td <?php echo ($this->data['meta']['transfer_type_id'] === '3') ? 'style="width:30%"' : 'style="width:40%"'; ?>>
                                            <div>
                                                <?php echo esc_html($value['name']); ?>
                                        ...
                                        <?php if ($this->data['meta']['transfer_type_id'] === '3'): ?>
                                            <td class="to-align-right" style="width:10%">
                                                <div>
                                                    <?php echo esc_html($value['quantity_return']); ?>
                                                </div>
                                            </td>
                                        <?php endif; ?>
                                        <td class="to-align-right" style="width:10%">
                                        ...
                                        <td class="to-align-right" style="width:10%">
                                            <div>
                                                <?php echo number_format(($value['quantity'] + $quantity_return) * $value['price'], 2, '.', ''); ?>
                                            </div>
                                        </td>
                                        ...
                                        <td class="to-align-right" style="width:15%">
                                            <div>
                                                <?php echo number_format(CHBSPrice::calculateGross($value['price'], 0, $value['tax_rate_value']) * ($value['quantity'] + $quantity_return), 2, '.', ''); ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
        ...
        <div id="meta-box-booking-8">
            <ul class="to-form-field-list">
                <li>
                    ...
                    <div class="to-radio-button">
                        <input type="radio" value="-1" id="<?php CHBSHelper::getFormName('driver_id_0'); ?>"
                               name="<?php CHBSHelper::getFormName('driver_id'); ?>" <?php CHBSHelper::checkedIf($this->data['meta']['driver_id'], -1); ?>/>
                        ...
                        foreach ($this->data['dictionary']['driver'] as $index => $value) {
                            ?>
                            <input type="radio" value="<?php echo esc_attr($index); ?>"
                                   id="<?php CHBSHelper::getFormName('driver_id_' . $index); ?>"
                                   name="<?php CHBSHelper::getFormName('driver_id'); ?>" <?php CHBSHelper::checkedIf($this->data['meta']['driver_id'], $index); ?>/>
                    ...
                    <li>
                        ...
                        <div class="to-radio-button">
                            <input type="radio" value="1"
                                   id="<?php CHBSHelper::getFormName('driver_mail_message_resend_1'); ?>"
                                   name="<?php CHBSHelper::getFormName('driver_mail_message_resend'); ?>"/>
                            ...
                            <input type="radio" value="0"
                                   id="<?php CHBSHelper::getFormName('driver_mail_message_resend_0'); ?>"
                                   name="<?php CHBSHelper::getFormName('driver_mail_message_resend'); ?>"
                                   checked="checked"/>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    if ($value['driver_id'] > 0) {
                                                        ?>
                                                        <a href="<?php echo get_edit_post_link($value['driver_id']); ?>"
                                                           target="_blank"><?php echo esc_html($value['driver_first_name'] . ' ' . $value['driver_second_name']); ?></a>
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
