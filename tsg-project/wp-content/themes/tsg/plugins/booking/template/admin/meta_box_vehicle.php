...
?>
                ...
                <div id="meta-box-vehicle-4">
                    <ul class="to-form-field-list">
                        <li>
                            <h5>Vehicle Visibility</h5>
                            <span class="to-legend">
                                Select visibility type.<br></span>
                            <div class="to-radio-button ui-controlgroup ui-controlgroup-horizontal ui-helper-clearfix" role="toolbar">
                                <input
                                        type="radio"
                                        value="1"
                                        id="<?php CHBSHelper::getFormName('visibility_type_1'); ?>"
                                        name="<?php CHBSHelper::getFormName('visibility_type'); ?>" <?php CHBSHelper::checkedIf($this->data['meta']['visibility_type'],1); ?>
                                />
                                <label for="<?php CHBSHelper::getFormName('visibility_type_1'); ?>">All</label>
                                <input
                                        type="radio"
                                        value="2"
                                        id="<?php CHBSHelper::getFormName('visibility_type_2'); ?>"
                                        name="<?php CHBSHelper::getFormName('visibility_type'); ?>" <?php CHBSHelper::checkedIf($this->data['meta']['visibility_type'],2); ?>
                                />
                                <label for="<?php CHBSHelper::getFormName('visibility_type_2'); ?>">Pricing rules only</label>
                            </div>
                        </li>
                        <li>
