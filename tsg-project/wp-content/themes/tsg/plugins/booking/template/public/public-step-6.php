...
?>
        <div class="chbs-clear-fix chbs-booking-complete">   
            ...
            <h3><?php esc_html_e('Thank you, your transfer added to cart.','chauffeur-booking-system'); ?></h3>
			<div class="chbs-booking-complete-payment">
				<div class="chbs-booking-complete-payment-paypal">
					<a href="#" class="chbs-button chbs-button-style-1"><?php esc_html_e('Pay via PayPal','car-rental-booking-system'); ?></a>	
