    ...
    function label($unit=-1,$type=1)
    {
        ...
        switch($type)
        {
            ...
            case 4:
                ...
                $label=$unit==2 ? esc_html__('Price per mile (return)','chauffeur-booking-system') : esc_html__('Price per kilometer (return)','chauffeur-booking-system');
                
            break;
        
            case 5:
                
                $label=$unit==2 ? esc_html__('Price per mile (return, new ride)','chauffeur-booking-system') : esc_html__('Price per kilometer (return, new ride)','chauffeur-booking-system');
